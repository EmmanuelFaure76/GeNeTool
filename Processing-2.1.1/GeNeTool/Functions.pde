...
File Gselection;
/*String selectOutput(String ask){
  selectOutput(ask, "fileSelected");
  println("exist output");
  if(Gselection==null) return "";
  else return Gselection.getAbsolutePath();
  
}
String selectOutput(){ return selectOutput("Select a file"); }
*/
/*
String selectInput(String ask){
  selectInput(ask, "fileSelected");
  if(Gselection==null) return "";
  else return Gselection.getAbsolutePath();
  
}*/
//String selectInput(){ return selectOutput("Select a file"); }
